...
const main=new Swiper('.main_swiper',{
  loop:true, //슬라이드 순환
  autoplay: { //자동재생
    delay: 4000, //지연시간, 밀리초 단위 - 1초=1000
    disableOnInteraction: false, //기본 true, 화면 클릭하면 멈추는거
  },
  pagination: {
    el: ".swiper-pagination",
    clickable: true, //클릭하면 거기로 이동함
  },
  navigation: {
    nextEl: ".main_next", //El -> element(요소)
    prevEl: ".main_prev",
  },
})
